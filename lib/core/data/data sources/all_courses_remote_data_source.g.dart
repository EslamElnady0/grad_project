...
part of 'all_courses_remote_data_source.dart';
...
class _AllCoursesRemoteDataSource implements AllCoursesRemoteDataSource {
  _AllCoursesRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger}) {
