...
class _AssignmentsRemoteDataSource implements AssignmentsRemoteDataSource {
  ...
  @override
  Future<AssignmentAnswersModel> getAssignmentsAnswers(int assignmentId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AssignmentAnswersModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'teachers/assignments/${assignmentId}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AssignmentAnswersModel _value;
    try {
      _value = AssignmentAnswersModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<AssignGradeResponseModel> gradeAssignment(
    int answerId,
    int degree,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = {'degree': degree};
    final _options = _setStreamType<AssignGradeResponseModel>(
      Options(
        method: 'PUT',
        headers: _headers,
        extra: _extra,
        contentType: 'application/x-www-form-urlencoded',
          ...
          .compose(
            _dio.options,
            'teachers/assignments/answer/${answerId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AssignGradeResponseModel _value;
    try {
      _value = AssignGradeResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DeleteAssignmentResponseModel> deleteAssignment(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeleteAssignmentResponseModel>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DeleteAssignmentResponseModel _value;
    try {
      _value = DeleteAssignmentResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
