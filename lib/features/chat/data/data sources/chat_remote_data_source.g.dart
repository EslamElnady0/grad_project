...
class _ChatRemoteDataSource implements ChatRemoteDataSource {
  ...
  @override
  Future<ChatGroupResponse> getChatGroups() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ChatGroupResponse>(
    ...
    late ChatGroupResponse _value;
    try {
      _value = ChatGroupResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<GroupDetailsResponse> getChatGroupDetails() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<GetMessagesResponse> getLatestMessages() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetMessagesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/chat/messages',
  ...
  @override
  Future<GetMessagesResponse> getOlder30Messages(String messageId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
