      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              leading:
                  const Icon(Icons.edit, color: AppColors.primaryColordark),
              title: Text(
                S.of(context).edit,
          ...
          ElevatedButton(
            onPressed: () {
              ...
              if (onDeleteConfirmed != null) {
                ...
                try {
                  context
                      .read<DeleteCourseMaterialCubit>()
                      .deleteCourseMaterial(item.id!);
                } catch (e) {
                  // Fallback to getIt if context.read fails
                  final deleteCourseMaterialCubit =
                      getIt<DeleteCourseMaterialCubit>();
