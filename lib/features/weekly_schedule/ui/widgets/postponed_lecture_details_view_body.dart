    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          PostponedDetailCard(
              context: context,
              title: S.of(context).lecture_details,
              children: [
                PostponedDetailRow(
                    context: context,
                ...
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).attendance_type,
          ...
          PostponedDetailCard(
              ...
              children: [
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).original_date,
                    value: postponedData['date'] ?? S.of(context).unknown),
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).original_day,
                    value: postponedData['day'] ?? S.of(context).unknown),
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).original_time_from,
                    value: postponedData['from'] ?? S.of(context).unknown),
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).original_time_to,
                    value: postponedData['to'] ?? S.of(context).unknown),
              ]),
          ...
          PostponedDetailCard(
              context: context,
              title: S.of(context).hall_details,
              children: [
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).hall,
                    value:
                        "${lecture.hall.building} (${lecture.hall.hallName})"),
                PostponedDetailRow(
                    context: context,
                    label: S.of(context).code,
                    value: lecture.hall.hallCode),
              ]),
